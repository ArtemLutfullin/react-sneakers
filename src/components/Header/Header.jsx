import './Header.scss';
import Head from '../../assets/img/image_4.svg';
...
const Header = () => {
  return (
    <div className="App">
      <div className="Head">
        <div className="Logo">
          <img src={Head} width="50px" height="50px" />
          <div className="LogoText">
            <p className="first-child">React Sneakers</p>
            <p className="TextDimmed" id="TextDimmed">
      ...
      <div className="Content">
        <h1 className="AllSneakersText">Все кроссовки</h1>
        ...
        <div className="Sneakers">
          ...
          <div className="Card">
            <img width={160} height={120} src={Sneakers2} alt="Sneakers" />
          ...
          <div className="Card">
            <img width={160} height={120} src={Sneakers3} alt="Sneakers" />
            <h5>Мужские Кроссовки Nike Blazer Mid Suede</h5>
            <div className="CardBottom">
              <div className="CardPrice">
                <p>Цена:</p>
                <b className="CardPriceB">8 999 руб. </b>
              </div>
              <button className="button">
                <img width={11} height={11} src={Content} alt="plus" />
              </button>
          ...
          <div className="Card">
            <img width={160} height={120} src={Sneakers4} alt="Sneakers" />
            <h5>Кроссовки Puma X Aka Boku Future Rider</h5>
            <div className="CardBottom">
              <div className="CardPrice">
                <p>Цена:</p>
                <b className="CardPriceB">8 499 руб.</b>
              </div>
              <button className="button">
                <img width={11} height={11} src={Content} alt="plus" />
              </button>
